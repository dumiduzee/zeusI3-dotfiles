...
start() {
  ...
  "/usr/lib/nekoray/nekobox_core" run -c "/home/zeus/.config/nekoray/config/sing-box-vpn.json" --protect-listen-path "/home/zeus/.config/nekoray/config/protect" --protect-fwmark 514
}
