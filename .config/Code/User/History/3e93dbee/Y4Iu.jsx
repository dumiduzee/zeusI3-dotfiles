...
import girl from '../assets/images/avatars/girl 2.png'
import girl from '../assets/images/avatars/grandfather 1.png'
import girl from '../assets/images/avatars/man-avatar 1.png'
import girl from '../assets/images/avatars/woman (1) 1.png'
import girl from '../assets/images/avatars/woman 1.png'
...
const Dashboard = () => {
  ...
  const recentActivity = [
    { id: '1', name: 'Dumidu Lakshan', amount: 'LKR 14000', date: '22 Jan 2022', time: '03:23AM', avatar: 'https://example.com/avatar1.png' },
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.beneficiaryContainer}>
          ...
          <TouchableOpacity style={styles.beneficiary}>
            <Image source={{ uri: 'https://example.com/beneficiary1.png' }} style={styles.beneficiaryImage} />
            <Text style={styles.beneficiaryName}>Lakmi</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.beneficiary}>
            <Image source={{ uri: 'https://example.com/beneficiary2.png' }} style={styles.beneficiaryImage} />
