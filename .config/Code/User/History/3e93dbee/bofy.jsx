...
const Dashboard = () => {
  ...
  const recentActivity = [
    { id: '1', name: 'Dumidu Lakshan', amount: 'LKR 14000', date: '22 Jan 2022', time: '03:23AM', avatar: girl3 },
    { id: '2', name: 'Sadew Kavishka', amount: 'LKR 1200', date: '21 Jan 2022', time: '03:23AM', avatar: girl4 },
    { id: '3', name: 'Malaka Saman', amount: 'LKR 12000', date: '20 Jan 2022', time: '03:23AM', avatar: girl5 },
    { id: '4', name: 'Madura Sadun', amount: 'LKR 23000', date: '19 Jan 2022', time: '03:23AM', avatar: girl },
  ];
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.balanceContainer}>
          <FontAwesome name="user-circle" size={30} color="#1E90FF" />
          <Text style={styles.balanceText}>{balance}</Text>
          <TouchableOpacity style={styles.searchButton}>
            <FontAwesome name="search" size={30} color="#1E90FF" />
          </TouchableOpacity>
        </View>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={styles.activityItem}>
              <Image source={item.avatar} style={styles.activityAvatar} />
...
const styles = StyleSheet.create({
  ...
  beneficiary: {
    ...
    borderRadius: 15,
    padding: 10,
    width: 100, // Increased width for larger space
    height: 100, // Increased height for larger space
  },
  beneficiaryText: {
    fontSize: 30,
    color: '#1E90FF',
  ...
  beneficiaryImage: {
    width: 40, // Slightly smaller to avoid sticking to borders
    height: 40,
    borderRadius: 30,
